...
namespace D3DHost
{
    //텍스쳐 파일 선택을 위해 개량한 클래스 for Property Grid
    class TextureEditor : DialogPropertyValueEditor
    {
        string template = @"
                <DataTemplate
                    ...
                    <DockPanel LastChildFill='True'>
                        ...
                        <TextBlock Name='TexturePath' Text='{Binding StringValue}' Margin='2,0,0,0' VerticalAlignment='Center'/>
                    </DockPanel>
                </DataTemplate>";
