...
extern "C" void WINAPI SetCamera(POINT pos)
{
	pManager->GetRenderer()->SetCamera( pos );
}

extern "C" int WINAPI TestCall()
{
	return 3;
}

extern "C" void WINAPI InitHappy(HWND hWnd)
{
	pHappy->RenInstance->InitDXApp(hWnd);
}