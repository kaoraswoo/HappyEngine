...
bool HSplatting::LoadTextures() 
{
	...
	bUpdateBaseTex = true;
	strBaseTex.clear();
	strBaseTex.insert(0, strFolderPath + "\\..\\..\\Data\\textures\\바닥.JPG");
	

	bUpdateSplatting[0] = true;
	strSplattingTex[0].clear();
	strSplattingTex[0].insert(0, strFolderPath + "\\..\\..\\Data\\textures\\녹색풀.jpg");

	bUpdateSplatting[1] = true;
	strSplattingTex[1].clear();
	strSplattingTex[1].insert(0, strFolderPath + "\\..\\..\\Data\\textures\\진흙.jpg");
	

	bUpdateSplatting[2] = true;
	strSplattingTex[2].clear();
	strSplattingTex[2].insert(0, strFolderPath + "\\..\\..\\Data\\textures\\회색돌.jpg");
